              ...
              <div class="row no-gutters">
                ...
                <div class="col-md-4">
                  <div class="card-body">
                    ...
                    <h2 class="card-text">{data?.description}</h2>
                    <p className="card-title">{data?.place}</p>
                    <p className="card-text">{data?.date}</p>
                    <p className="card-title">
                      You can enroll in the event by clicking on the below
                      button
                    </p>
                    <Button
                      variant="primary"
                      onClick={(e) =>
                        handlOnClick(e, data?.eventname, data?.id)
                      }
                    >
                      ENROLL
                    </Button>
              ...
              <div class="row no-gutters">
                ...
                <div class="col-md-4">
                  <div class="card-body">
                    ...
                    <p className="card-title">{another?.place}</p>
                    <p className="card-text">{data?.date}</p>
                    <p className="card-title">
                      You can enroll in the event by clicking on the below
                      button
                    ...
                    <Button
                      variant="primary"
                      onClick={(e) =>
                        handlOnClick(e, another?.eventname, another?.id)
                      }
                    >
                      ENROLL
                    </Button>
